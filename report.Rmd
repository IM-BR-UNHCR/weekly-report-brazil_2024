...
subtitle: WEEK `r if( lubridate::isoweek(lubridate::today()-1) == 1) {52} else { lubridate::isoweek(lubridate::today())-1}  `/`r lubridate::year(lubridate::today())`
