...
subtitle: WEEK `r if( lubridate::isoweek(lubridate::one_week_ago_date()) == 1) {52} else { lubridate::isoweek(lubridate::one_week_ago_date())}  `/`r lubridate::year(lubridate::one_week_ago_date())`
