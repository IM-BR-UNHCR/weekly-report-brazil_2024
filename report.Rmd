...
subtitle: WEEK `r if( lubridate::isoweek(lubridate::previous_week()) == 1) {52} else { lubridate::isoweek(lubridate::previous_week())}  `/`r lubridate::year(lubridate::previous_week())`
